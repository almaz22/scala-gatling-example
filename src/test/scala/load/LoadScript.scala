...
class LoadScript extends Simulation {
  ...
  /**
    ...
    * За конкретную интенсивность берем ожидаемый уровень нагрузки (100 tps, к примеру, при 80%
    * от максимальной нагрузки) и подвергаем на длительный тест (12 часов)
    */
  setUp(
    loadScn.inject(
